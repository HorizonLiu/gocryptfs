...
func TestInitFilePerms(t *testing.T) {
	...
	// https://github.com/HorizonLiu/gocryptfs/issues/387 .
	// From v2.0, created with 0444 perms, see
	// https://github.com/HorizonLiu/gocryptfs/issues/539 .
	if perms != 0444 {
...
// Something like
//   gocryptfs a b | cat
// must not hang ( https://github.com/HorizonLiu/gocryptfs/issues/130 ).
...
// Make sure bug https://github.com/HorizonLiu/gocryptfs/issues/258 does not come
// back.
...
// https://github.com/HorizonLiu/gocryptfs/issues/262
...
// NOT get unmounted. Regression test for https://github.com/HorizonLiu/gocryptfs/issues/421
...
// followed.
// https://github.com/HorizonLiu/gocryptfs/issues/450
...
// if CIPHERDIR is not empty. See https://github.com/HorizonLiu/gocryptfs/pull/503
