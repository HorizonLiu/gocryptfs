...
// See README.md ( https://github.com/HorizonLiu/gocryptfs/blob/master/README.md )
...
import (
	...
	"github.com/HorizonLiu/gocryptfs/internal/speed"
...
func doMain(cmd []string, password string) {
	...
	// 若不传入-fg参数，或者执行mount操作，将会fork子进程去执行
