...
[![Go Report Card](https://goreportcard.com/badge/github.com/HorizonLiu/gocryptfs)](https://goreportcard.com/report/github.com/HorizonLiu/gocryptfs)
[![Latest release](https://img.shields.io/github/release/rfjakob/gocryptfs.svg)](https://github.com/HorizonLiu/gocryptfs/releases)
[![Homebrew version](https://img.shields.io/homebrew/v/gocryptfs.svg)](https://formulae.brew.sh/formula/gocryptfs#default)

An encrypted overlay filesystem written in Go.
Official website: https://nuetzlich.net/gocryptfs ([markdown source](https://github.com/HorizonLiu/gocryptfs-website/blob/master/docs/index.md)).
...
[ticket #15](https://github.com/HorizonLiu/gocryptfs/issues/15) for the history
...
[fuse-xfstests](https://github.com/HorizonLiu/fuse-xfstests) project. gocryptfs
...
With go 1.11 or higher:
	...
	$ git clone https://github.com/HorizonLiu/gocryptfs.git
	$ cd gocryptfs
	$ ./build.bash
...
implementation. See [CPU-Benchmarks](https://github.com/HorizonLiu/gocryptfs/wiki/CPU-Benchmarks)
...
* Make ACLs *actually* work (pass `-acl` to enable) ([#536](https://github.com/HorizonLiu/gocryptfs/issues/536))
* Blocklist RENAME_EXCHANGE and RENAME_WHITEOUT (broken as discovered by [fuse-xfstest/gocryptfs-2019-12](https://github.com/HorizonLiu/fuse-xfstests/tree/gocryptfs-2019-12))

v2.0-beta3, 2021-04-24
* MANPAGE: Split options into sections acc. to where they apply ([#517](https://github.com/HorizonLiu/gocryptfs/issues/517))
* `-idle`: count cwd inside the mount as busy ([#533](https://github.com/HorizonLiu/gocryptfs/issues/533))
* Make `gocryptfs.diriv` and `gocryptfs.xxx.name` files world-readable to make encrypted backups easier
  when mounting via [/etc/fstab](Documentation/MANPAGE.md#fstab) ([#539](https://github.com/HorizonLiu/gocryptfs/issues/539))
* Make it work with MacFUSE v4.x ([#524](https://github.com/HorizonLiu/gocryptfs/issues/524))
* **Disable ACL encryption**, it causes a lot of problems ([#543](https://github.com/HorizonLiu/gocryptfs/issues/543),
  [#536](https://github.com/HorizonLiu/gocryptfs/issues/536))
...
* Include `gocryptfs-xray` in binary releases ([#496](https://github.com/HorizonLiu/gocryptfs/issues/496))
* go-fuse: track *most recent* parent. This improves robustness when the filesystem is modified behind
  ...
  [#549](https://github.com/HorizonLiu/gocryptfs/issues/549))
* Add directory fd caching for 2x - 3x speed boost in small file ops compared to v2.0-beta2
  ([performance numbers](https://github.com/HorizonLiu/gocryptfs/blob/5cb1e55714aa92a848c0fb5fc3fa7b91625210fe/Documentation/performance.txt#L73))

v2.0-beta2, 2020-11-14
* Improve [performance](Documentation/performance.txt#L69)
* Fix [GETATTR panic](https://github.com/HorizonLiu/gocryptfs/issues/519#issuecomment-718790790) in reverse mode
...
* **Add support for FIDO2 tokens (`-fido2`, [#505](https://github.com/HorizonLiu/gocryptfs/pull/505))**
* Add `-encrypt-paths` / `-decrypt-paths` functionality to `gocryptfs-xray`
  ([#416](https://github.com/HorizonLiu/gocryptfs/issues/416))
* Accept multiple `-passfile`s
  ([#288](https://github.com/HorizonLiu/gocryptfs/issues/288))
* Make `-masterkey=stdin` work together with `-passwd`
  ([#461](https://github.com/HorizonLiu/gocryptfs/issues/461))
* Fix `Unknown opcode 2016` crash on Google Cloud
  ([go-fuse #276](https://github.com/hanwen/go-fuse/issues/276),
  [gocryptfs commit ec74d1d](https://github.com/HorizonLiu/gocryptfs/commit/ec74d1d2f4217a9a337d1db9902f32ae2aecaf33))

v1.8.0, 2020-05-09
* Enable ACL support ([#453](https://github.com/HorizonLiu/gocryptfs/issues/453))
  * **Warning 2021-02-07**: This feature is incomplete! Do not use ACLs before gocryptfs v2.0 final!
    Reading and writing ACLs works, but they are not enforced or inherited ([#542](https://github.com/HorizonLiu/gocryptfs/issues/542))
* Ignore `.nfsXXX` temporary files
  ([#367](https://github.com/HorizonLiu/gocryptfs/issues/431))
* Handle inode number collisions from multiple devices
  ([#435](https://github.com/HorizonLiu/gocryptfs/issues/435))
* Drop `-nonempty` for fusermount3
  ([#440](https://github.com/HorizonLiu/gocryptfs/pull/440))
* Reverse mode: improve inode number mapping and max=1000000000000000000 limitation
  ([#457](https://github.com/HorizonLiu/gocryptfs/issues/457))
* Enable `--buildmode=pie` ([#460](https://github.com/HorizonLiu/gocryptfs/pull/460))
* Migrate from dep to Go Modules
  ([commit cad711993](https://github.com/HorizonLiu/gocryptfs/commit/cad711993d67dd920f9749a09414dbbba6ab8136))
* go mod: update dependencies
  ([commit b23f77c](https://github.com/HorizonLiu/gocryptfs/commit/b23f77c8ead0dbb5ed59dd50e94f13aacf7dbaf1))
* `gocryptfs -speed`: add XChaCha20-Poly1305-Go
  ([#452](https://github.com/HorizonLiu/gocryptfs/issues/452))
* Respect `GOMAXPROCS` environment variable
  ([commit ff210a06f](https://github.com/HorizonLiu/gocryptfs/commit/ff210a06fb3097eecd5668ddb3ace9c76873eb00)
...
* Support wild cards in reverse mode via `--exclude-wildcard`
  ([#367](https://github.com/HorizonLiu/gocryptfs/pull/367)). Thanks @ekalin!
* Create `gocryptfs.diriv` files with 0440 permissions to make it easier to
  share an encrypted folder via a network drive
  ([#387](https://github.com/HorizonLiu/gocryptfs/issues/387)).
...
* `-passwd` can now change the `-scryptn` parameter for existing filesystems
  ([#400](https://github.com/HorizonLiu/gocryptfs/issues/400))
* Fix `-idle` unmounting the filesystem despite recent activity
  ([#421](https://github.com/HorizonLiu/gocryptfs/issues/421))
* **Fix a race condition related to inode number reuse
  ([#363](https://github.com/HorizonLiu/gocryptfs/issues/363))**.
...
* tests: use /var/tmp instead of /tmp by default
  ([commit 8c4429](https://github.com/HorizonLiu/gocryptfs/commit/8c4429408716d9890a98a48c246d616dbfea7e31))
...
* Reverse mode: fix excluded, unaccessible files showing up in directory listings
  ([#285](https://github.com/HorizonLiu/gocryptfs/issues/285),
  [#286](https://github.com/HorizonLiu/gocryptfs/issues/286))
* gocryptfs-xray: add `-aessiv` flag for correctly parsing AES-SIV format files
  ([#299](https://github.com/HorizonLiu/gocryptfs/issues/299))
* Ensure that standard fds 0,1,2 are always initialized
  ([#320](https://github.com/HorizonLiu/gocryptfs/issues/320)).
...
* `-extpass` now can be specified multiple times to support arguments containing spaces
  ([#289](https://github.com/HorizonLiu/gocryptfs/issues/289))
...
* Use `Setreuid` to robustly set the owner with allow_other (@slackner,
  ([commit](https://github.com/HorizonLiu/gocryptfs/commit/03b9d65cce53fb95b7d489ecd03d0853b9b923fb)))
* Pack the rendered man page into the source code archive for user convenience
  ([issue 355](https://github.com/HorizonLiu/gocryptfs/issues/355))
* Disable Trezor support again (commit 16fac26c57ba303bf60266d24c17f5243e5ea376)
  * Trezor support has been broken since Sept 2018 due to issues
    in a third-party module ([#261](https://github.com/HorizonLiu/gocryptfs/issues/261))

v1.6.1, 2018-12-12
* Fix "Operation not supported" chmod errors on Go 1.11
  ([#271](https://github.com/HorizonLiu/gocryptfs/issues/271))

v1.6, 2018-08-18
* **Add `-e` / `-exclude` option** for reverse mode
  ([#235](https://github.com/HorizonLiu/gocryptfs/issues/235),
  [commit](https://github.com/HorizonLiu/gocryptfs/commit/ec2fdc19cf9358ae7ba09c528a5807b6b0760f9b))
* Add support for the Trezor One HSM [PR#247](https://github.com/HorizonLiu/gocryptfs/pull/247), thanks @xaionaro!
...
* Only print master key once, on init
  ([#76](https://github.com/HorizonLiu/gocryptfs/issues/76),
  [commit](https://github.com/HorizonLiu/gocryptfs/commit/6d64dfe8f7acd8e9ca4a659d26318e442c2db85a))
* Fall back to buffered IO even when passed `O_DIRECT`
  ([commit](https://github.com/HorizonLiu/gocryptfs/commit/893e41149ed353f355047003b89eeff456990e76))

v1.5, 2018-06-12
* **Support extended attributes (xattr)** in forward mode
  ([#217](https://github.com/HorizonLiu/gocryptfs/issues/217)). Older gocryptfs versions
  will ignore the extended attributes.
* **Add `-fsck` function**
  ([#191](https://github.com/HorizonLiu/gocryptfs/issues/191))
* Fix clobbered timestamps on MacOS High Sierra
  ([#229](https://github.com/HorizonLiu/gocryptfs/issues/229))
* Add `-masterkey=stdin` functionality
  ([#218](https://github.com/HorizonLiu/gocryptfs/issues/218))
* Accept `-dev`/`-nodev`, `suid`/`nosuid`, `-exec`/`-noexec`,
  `-ro`/`-rw` flags to make mounting via `/etc/fstab` possible.
  Thanks @mahkoh! ([#233](https://github.com/HorizonLiu/gocryptfs/pull/233),
  [commit](https://github.com/HorizonLiu/gocryptfs/commit/53d6a9999dd0e4c31636d16179f284fff35a35d9),
  [commit](https://github.com/HorizonLiu/gocryptfs/commit/10212d791a3196c2c8705a7a3cccdeb14a8efdbe))
* Fix a `logger` path issue on SuSE
  [#225](https://github.com/HorizonLiu/gocryptfs/issues/225)
* Stop printing the help text on a "flag provided but not defined"
  error ([commit](https://github.com/HorizonLiu/gocryptfs/commit/5ad26495fc86527bbfe75ac6b46528d49a373676))

v1.4.4, 2018-03-18
* Overwrite secrets in memory with zeros as soon as possible
  ([#211](https://github.com/HorizonLiu/gocryptfs/issues/211))
* Fix Getdents problems on i386 and mips64le
  ([#197](https://github.com/HorizonLiu/gocryptfs/issues/197),
  [#200](https://github.com/HorizonLiu/gocryptfs/issues/200))
* Make building with gccgo work
  ([#201](https://github.com/HorizonLiu/gocryptfs/issues/201))
* MacOS: fix `osxfuse: vnode changed generation` / `Error code -36` issue in go-fuse
  ([#213](https://github.com/HorizonLiu/gocryptfs/issues/213),
...
* **Fix several symlink race attacks** in connection with reverse mode
  ...
  * Fix symlink races in reverse mode
    ([issue #165](https://github.com/HorizonLiu/gocryptfs/issues/165))
  * Fix symlink races in connection with `-allow_other`
    ([issue #177](https://github.com/HorizonLiu/gocryptfs/issues/177))
* Fix problems with special names when using `-plaintextnames`
  ([issue #174](https://github.com/HorizonLiu/gocryptfs/issues/174))
* Add `-devrandom` command-line option
  ([commit](https://github.com/HorizonLiu/gocryptfs/commit/f3c777d5eaa682d878c638192311e52f9c204294))
* Add `-sharedstorage` command-line option
  ([commit](https://github.com/HorizonLiu/gocryptfs/commit/e36a0ebf189a826aaa63909c5518c16356f5f903),
  [issue #156](https://github.com/HorizonLiu/gocryptfs/issues/156))
* MacOS: let OSXFuse create the mountpoint if it does not exist
  ([issue #194](https://github.com/HorizonLiu/gocryptfs/issues/194))

v1.4.2, 2017-11-01
* Add `Gopkg.toml` file for `dep` vendoring and reproducible builds
  ([issue #142](https://github.com/HorizonLiu/gocryptfs/issues/142))
* MacOS: deal with `.DS_Store` files inside CIPHERDIR
  ([issue #140](https://github.com/HorizonLiu/gocryptfs/issues/140))
* Reverse mode: fix ENOENT error affecting names exactly 176 bytes long
  ([issue #143](https://github.com/HorizonLiu/gocryptfs/issues/143))
* Support kernels compiled with > 128 kiB FUSE request size (Synology NAS)
  ([issue #145](https://github.com/HorizonLiu/gocryptfs/issues/145),
  [commit](https://github.com/HorizonLiu/gocryptfs/commit/4954c87979efaf5b8184efccc7d9a38c21e4209b))
* Fix a startup hang when `$PATH` contains the mountpoint
  ([issue #146](https://github.com/HorizonLiu/gocryptfs/issues/146))

v1.4.1, 2017-08-21
* **Use memory pools for buffer handling** (
  [3c6fe98](https://github.com/HorizonLiu/gocryptfs/commit/3c6fe98),
  [b2a23e9](https://github.com/HorizonLiu/gocryptfs/commit/b2a23e9),
  [12c0101](https://github.com/HorizonLiu/gocryptfs/commit/12c0101))
  * On my machine, this **doubles** the streaming read speed
    (see [performance.txt](https://github.com/HorizonLiu/gocryptfs/blob/v1.4.1/Documentation/performance.txt#L38))
* Implement and use the getdents(2) syscall for a more efficient
  OpenDir implementation
  ([e50a6a5](https://github.com/HorizonLiu/gocryptfs/commit/e50a6a5))
* Purge masterkey from memory as soon as possible
  ([issue #137](https://github.com/HorizonLiu/gocryptfs/issues/137))
* Reverse mode: fix inode number collision between .name and .diriv
  files
  ([d12aa57](https://github.com/HorizonLiu/gocryptfs/commit/d12aa57))
* Prevent the logger from holding stdout open
  ([issue #130](https://github.com/HorizonLiu/gocryptfs/issues/130))
* MacOS: make testing without openssl work properly
  ([ccf1a84](https://github.com/HorizonLiu/gocryptfs/commit/ccf1a84))
* MacOS: specify a volume name
  ([9f8e19b](https://github.com/HorizonLiu/gocryptfs/commit/9f8e19b))
* Enable writing to write-only files
  ([issue #125](https://github.com/HorizonLiu/gocryptfs/issues/125))
...
* Increase open file limit to 4096 ([#82](https://github.com/HorizonLiu/gocryptfs/issues/82)).
* Implement path decryption via ctlsock ([#84](https://github.com/HorizonLiu/gocryptfs/issues/84)).
...
* Reverse mode: make sure hard-linked files always return the same
  ciphertext
  ([commit 9ecf2d1a](https://github.com/HorizonLiu/gocryptfs/commit/9ecf2d1a3f69e3d995012073afe3fc664bd928f2))
* Display a shorter, friendlier help text by default.
* **Parallelize file content encryption** by splitting data blocks into two
  threads ([ticket#116](https://github.com/HorizonLiu/gocryptfs/issues/116))
* Prefetch random nonces in the background
  ([commit 80516ed](https://github.com/HorizonLiu/gocryptfs/commit/80516ed3351477793eec882508969b6b29b69b0a))
...
* Add `-serialize_reads` command-line option
  * This can greatly improve performance on storage
    ...
    Amazon Cloud Drive ([#92](https://github.com/HorizonLiu/gocryptfs/issues/92))
* Reject file-header-only files
  ([#90 2.2](https://github.com/HorizonLiu/gocryptfs/issues/90),
  [commit](https://github.com/HorizonLiu/gocryptfs/commit/14038a1644f17f50b113a05d09a2a0a3b3e973b2))
* Increase max password size to 2048 bytes ([#93](https://github.com/HorizonLiu/gocryptfs/issues/93))
...
* Make the test suite work on [Mac OS X](https://github.com/HorizonLiu/gocryptfs/issues/15)
...
* Under certain circumstances, concurrent truncate and read could return
  ...
  ([commit](https://github.com/HorizonLiu/gocryptfs/commit/0489d08ae21107990d0efd0685443293aa26b35f)).
* Coalesce 4kB ciphertext block writes up to the size requested through
  the write FUSE call
  ([commit with benchmarks](https://github.com/HorizonLiu/gocryptfs/commit/024511d9c71558be4b1169d6bb43bd18d65539e0))
* Add `-noprealloc` command-line option
  * Greatly speeds up writes on Btrfs
    ([#63](https://github.com/HorizonLiu/gocryptfs/issues/63))
    at the cost of reduced out-of-space robustness.
  * This is a workaround for Btrfs' slow fallocate(2)
* Preserve owner for symlinks an device files (fixes bug [#64](https://github.com/HorizonLiu/gocryptfs/issues/64))
...
* Work around an issue in tmpfs that caused a panic in xfstests generic/075
  ([gocryptfs#56](https://github.com/HorizonLiu/gocryptfs/issues/56))
* Optimize NFS streaming writes
  ([commit](https://github.com/HorizonLiu/gocryptfs/commit/a08d55f42d5b11e265a8617bee16babceebfd026))

v1.1, 2016-10-19
* **Add reverse mode ([#19](https://github.com/HorizonLiu/gocryptfs/issues/19))**
...
* Accept `-o foo,bar,baz`-style options that are passed at the end of
  ...
  * This allows **mounting from /etc/fstab**. See
    [#45](https://github.com/HorizonLiu/gocryptfs/issues/45) for details.
  * **Mounting on login using pam_mount** works as well. It is
    [described in the wiki](https://github.com/HorizonLiu/gocryptfs/wiki/Mounting-on-login-using-pam_mount).
...
* Enable changing the password when you only know the master key
  ([#28](https://github.com/HorizonLiu/gocryptfs/issues/28))
...
* Experimental Mac OS X support. See
  [ticket #15](https://github.com/HorizonLiu/gocryptfs/issues/15) for details.

v0.12, 2016-06-19
* Deprecate very old filesystems, stage 2/3
  * Filesystems created by v0.6 and older can only be mounted read-only
  * A [message](https://github.com/HorizonLiu/gocryptfs/blob/v0.12/internal/configfile/config_file.go#L120)
    explaining the situation is printed as well
* New command line option: `-ro`
  * Mounts the filesystem read-only
* Accept password from stdin as well ([ticket #30](https://github.com/HorizonLiu/gocryptfs/issues/30))

v0.11, 2016-06-10
* Deprecate very old filesystems, stage 1/3
  * Filesystems created by v0.6 and older can still be mounted but a
    [warning](https://github.com/HorizonLiu/gocryptfs/blob/v0.11/internal/configfile/config_file.go#L120)
    is printed
  * See [ticket #29](https://github.com/HorizonLiu/gocryptfs/issues/29) for details and
    join the discussion
...
* Build release binaries with Go 1.6.2
  * Big speedup for CPUs with AES-NI, see [ticket #23](https://github.com/HorizonLiu/gocryptfs/issues/23)

v0.10, 2016-05-30
* **Replace `spacemonkeygo/openssl` with `stupidgcm`**
  * gocryptfs now has its own thin wrapper to OpenSSL's GCM implementation
    called `stupidgcm`.
  * This should fix the [compile issues](https://github.com/HorizonLiu/gocryptfs/issues/21)
    people are seeing with `spacemonkeygo/openssl`. It also gets us
    a 20% performance boost for streaming writes.
* **Automatically choose between OpenSSL and Go crypto** [issue #23](https://github.com/HorizonLiu/gocryptfs/issues/23)
...
* Warn but continue anyway if fallocate(2) is not supported by the
  underlying filesystem, see [issue #22](https://github.com/HorizonLiu/gocryptfs/issues/22)
  * Enables to use gocryptfs on ZFS and ext3, albeit with reduced out-of-space safety.
* [Fix statfs](https://github.com/HorizonLiu/gocryptfs/pull/27), by @lxp
...
* **Wide-block filename encryption using EME + DirIV**
  * EME (ECB-Mix-ECB) provides even better security than CBC as it fixes
    ...
    https://github.com/HorizonLiu/eme which is, as far as I know, the first
